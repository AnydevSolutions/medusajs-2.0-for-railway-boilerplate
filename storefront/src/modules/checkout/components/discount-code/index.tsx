      ...
      <div className="txt-medium">
        {gift_cards.length > 0 && (
          <div className="flex flex-col mb-4">
            <Heading className="txt-medium">Tarjeta(s) Aplicadas:</Heading>
            {gift_cards?.map((gc) => (
              <div
              ...
              >
                ...
                >
                  <Trash size={14} />
                  <span className="sr-only">Remover tarjeta de regalo</span>
                </button>
              </div>
            ))}
          </div>
        ...
        {appliedDiscount ? (
          ...
          <form action={formAction} className="w-full">
            <Label className="flex gap-x-1 my-2 items-center">
              ...
              <Tooltip content="Puedes agregar unicamente 1 código de descuento.">
