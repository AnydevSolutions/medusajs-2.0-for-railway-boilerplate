...
const Certificated = ({ width = 112, height = 96 }) => {
    return (
        <div>
            ...
            <path d="M49 41L52.4373 44.4373C53.274 45.274 54.6502 45.2054 55.3994 44.2896L63 35" stroke="#00d1ac" stroke-width="2" stroke-linecap="round" />
            <defs>
