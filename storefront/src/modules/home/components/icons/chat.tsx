...
const Chat = ({ width = 112, height = 96 }) => {
    return (
        <div>
...
<path d="M42 72H70L75.1056 61.7889C76.4354 59.1292 74.5014 56 71.5279 56H40.4721C37.4986 56 35.5646 59.1292 36.8944 61.7889L42 72Z" fill="#00d1ac"/>
</g>
...
<rect x="42" y="26" width="18" height="3" rx="1" fill="#00d1ac"/>
...
<circle cx="56" cy="66" r="8" fill="#00d1ac"/>
<circle cx="56" cy="66" r="8.5" stroke="#00d1ac"/>
</g>
